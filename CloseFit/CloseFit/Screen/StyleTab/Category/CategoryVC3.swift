...
extension CategoryVC3: UICollectionViewDelegateFlowLayout{
...
extension CategoryVC3: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return CategoryVC3.clothList.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        clothCell.dataBind(model: CategoryVC3.clothList[indexPath.row])
        return clothCell
    }
}
