...
extension CategoryVC2: UICollectionViewDelegateFlowLayout{
...
extension CategoryVC2 : UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return CategoryVC2.clothList.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        clothCell.dataBind(model: CategoryVC2.clothList[indexPath.row])
        return clothCell
    }
}
