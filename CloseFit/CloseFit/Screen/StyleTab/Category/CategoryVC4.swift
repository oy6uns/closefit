...
extension CategoryVC4: UICollectionViewDelegateFlowLayout{
...
extension CategoryVC4: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return CategoryVC4.clothList.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        clothCell.dataBind(model: CategoryVC4.clothList[indexPath.row])
        return clothCell
    }
}
